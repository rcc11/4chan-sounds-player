module.exports = [
	...
	},
	{
		...
		title: 'Hosts',
		actions: [ { title: 'Add', handler: 'settings.addUploadHost' } ],
		default: 'sound-name h:{menu-button}',
		displayGroup: 'Hosts',
		displayMethod: 'settings.renderHosts',
		parse: 'settings.parseHosts',
		looseCompare: true,
		text: '<div><strong>Properties</strong>'
			...
			+ '<br><strong>Data</strong>: The form data for the upload (as JSON). Specify the file using $file.</div>',
		mix: true,
		default:  {
			catbox: {
				default: true,
